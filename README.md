...
- Rather than having the below nasty if block:
```
...
```
I introduced a private method `preferred_diet` which will check to make sure the category matches what the dino should be eating. 
- 